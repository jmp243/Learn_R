...
Read in data from this URL - https://raw.githubusercontent.com/jmp243/Learn_R/refs/heads/main/fake_program_data.csv
...
Parse out the age groups Create an reference number for each event
...
Faded examples = fill in the blanks, e.g.: ggplot(data = ***, mapping = aes(x =*** , y = \_\_*)) + geom*\*() +
...
creating a visualization can be helpful. \## group data by attendance
